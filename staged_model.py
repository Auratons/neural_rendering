...
def create_computation_graph(
    x_in, x_gt, x_app=None, arch_type="pggan", use_appearance=True
):
    ...
    if opts.use_vgg_loss:
        ...
        vgg_layer_weights = [1.0 / 32, 1.0 / 16, 1.0 / 8, 1.0 / 4, 1.0]
        vgg_loss = losses.PerceptualLoss(
            y, x_gt, [256, 256, 3], vgg_layers, vgg_layer_weights
        )  # NOTE: shouldn't hardcode image size!
